...
gehalten wird, wird der \emph{RecentChangeStorage} mithilfe eines Observer-Patterns % //TODO source
...
\emph{diff-match-patch}-Algorithmus % //TODO source
...
GitHub Actions, GitLab CI und Travis CI.
